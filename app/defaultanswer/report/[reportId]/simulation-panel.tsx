...
export function SimulationPanel({ domain, url, analysis }: Props) {
  ...
  return (
    <div className="mb-10 border border-stone-200 dark:border-stone-800 rounded-lg p-5 bg-white dark:bg-stone-900">
