        ...
        <div className="mx-auto mt-5 max-w-3xl space-y-6">
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-5 dark:border-stone-800 dark:bg-stone-950">
            ...
            <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
              Search engines rank documents; AI systems generate answers. A website can rank highly and still be skipped
              if it is hard to describe, hard to quote, or hard to justify as a source.
            </p>
          </div>

          {/* TL;DR in a card for consistency */}
          <div className="rounded-2xl border border-stone-200 bg-white p-5 dark:border-stone-800 dark:bg-stone-950">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
              <li>Search engines rank documents; AI assistants need sources they can quote and justify.</li>
              <li>Sites get skipped when definitions, answers, or legitimacy signals are hard to extract.</li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 grid gap-2 text-sm text-stone-600 dark:text-stone-300 sm:grid-cols-2">
              {[
                ["#ranking-not-recommending", "Ranking ≠ recommending"],
        ...
        <div className="mx-auto mt-10 max-w-3xl space-y-12 text-stone-700 dark:text-stone-300">
          <div className="border-t border-stone-200 pt-8 dark:border-stone-800">
            <section id="ranking-not-recommending" className="space-y-4">
              ...
              <p className="leading-relaxed">
                This is not a temporary gap, and it is not a failure of &quot;AI SEO.&quot; It follows directly from how
              ...
              <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-950">
                <p className="text-sm leading-relaxed text-stone-700 dark:text-stone-300">
                  In practice, ranking well does not guarantee being recommended. AI systems do not ask, “Which page
                  should I show?” They ask, implicitly, “Which source can I use to answer this question clearly and
                  safely?”
                </p>
              </div>
          ...
          <div className="border-t border-stone-200 pt-8 dark:border-stone-800">
            <section id="observable-source-selection-patterns" className="space-y-4">
              ...
              <p className="leading-relaxed">
                The internal mechanics of AI systems are proprietary. Their behavior is observable across common AI
                assistants. Several patterns are consistent.
              </p>

              {/* Replace bullet wall with a card grid (matches your best-looking sections) */}
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-950">
                  <h3 className="text-sm font-semibold text-stone-900 dark:text-stone-50">Clear description</h3>
                  <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
                ...
                <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-950">
                  <h3 className="text-sm font-semibold text-stone-900 dark:text-stone-50">Extractable answers</h3>
                  <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
                ...
                <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-950">
                  <h3 className="text-sm font-semibold text-stone-900 dark:text-stone-50">Justifiable sources</h3>
                  <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
                ...
                <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-950">
                  <h3 className="text-sm font-semibold text-stone-900 dark:text-stone-50">Retrievable content</h3>
                  <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
          ...
          <div className="border-t border-stone-200 pt-8 dark:border-stone-800">
            <section id="common-failure-patterns" className="space-y-6">
              ...
              <p className="leading-relaxed">
                When AI assistants avoid a website, it is rarely because the content is low quality. More often, the site
                creates uncertainty at the moment an answer must be formed.
              </p>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">{item.body}</p>
                    <p className="mt-2 text-xs leading-relaxed text-stone-600 dark:text-stone-300">
                      <span className="font-semibold text-stone-900 dark:text-stone-50">Typical symptom:</span>{" "}
                      {item.symptom}
                    </p>
                  </div>
                ))}
          ...
          <div className="border-t border-stone-200 pt-8 dark:border-stone-800">
            <section id="what-to-fix-first" className="space-y-4">
              ...
              <p className="leading-relaxed">
                In many cases, small changes remove disproportionate amounts of uncertainty. The goal is not to optimize everything.
                The goal is to reduce the moments where an AI system must guess.
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  >
                    <h3 className="text-sm font-semibold text-stone-900 dark:text-stone-50">{c.title}</h3>
                    <p className="mt-2 text-sm leading-relaxed text-stone-700 dark:text-stone-300">{c.body}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-stone-200 bg-white p-5 dark:border-stone-800 dark:bg-stone-950">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm font-semibold text-stone-900 dark:text-stone-50">Want the diagnosis for your site?</p>
                  ...
                  <Link
                    href="/defaultanswer"
                    className="inline-flex items-center justify-center rounded-xl border border-stone-200 bg-white px-4 py-2 text-sm font-medium text-stone-900 shadow-sm hover:bg-stone-100 dark:border-stone-800 dark:bg-stone-950 dark:text-stone-50 dark:hover:bg-stone-900"
                  >
                    Analyze
                  </Link>
                </div>
